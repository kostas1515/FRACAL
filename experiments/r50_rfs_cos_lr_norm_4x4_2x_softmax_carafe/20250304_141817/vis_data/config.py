...
launcher = 'pytorch'
load_from = './experiments/r50_rfs_cos_lr_norm_4x4_2x_softmax_carafe/epoch_24.pth'
log_level = 'INFO'
...
model = dict(
    ...
    roi_head=dict(
        ...
        mask_head=dict(
            ...
            num_classes=1203,
            num_convs=4,
            predictor_cfg=dict(learnable_temp=True, type='NormedConv2d'),
            type='FCNMaskHead',
            upsample_cfg=dict(
...
work_dir = './experiments/r50_rfs_cos_lr_norm_4x4_2x_softmax_carafe/'
